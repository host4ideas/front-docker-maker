            ...
            {navigations.map((route, index) => (
              <li key={index}>
                <Link
                  to={route.path}
                  className={
                    'flex items-center rounded-lg p-2 text-base font-normal text-gray-900 dark:text-white hover:bg-gray-700 dark:hover:bg-gray-700 ' +
                    (pathname.includes(route.path)
                      ? 'bg-gray-700 dark:bg-gray-700 hover:bg-gray-400 dark:hover:bg-gray-700 dark:text-black'
                      : '')
                  }
                >
                  {route.icon}
